...
const VtuberCard =
  ...
  async (
    ...
    if (platform === 'twitter') {
      const photoMediaId = await twitterAssetManager.getMedia(
        `photo-${vtuber.id}`
      );
      return (
        <>
          ...
          <Twitter.DirectMessage
            media={<Twitter.Photo mediaId={photoMediaId} />}
            buttons={
              <>
                {withTwitterButton && (
                  <Twitter.UrlButton label={twitterLabel} url={twitterUrl} />
                )}
                {withYoutubeButton && (
                  <Twitter.UrlButton label={youtubeLabel} url={youtubeUrl} />
                )}
                <TwitterWebviewButton
            ...
            quickReplies={
              withOkButton && (
                <Twitter.QuickReply label={okLabel} metadata={okData} />
              )
            }
          >
            {title}
...
export default makeContainer({ deps: [TwitterAssetManager] })(VtuberCard);
